...
return {
	-- Insert next post here
	{
		...
		short_url = 'lua-quick-reference-pre-orders', -- Short url and same as md file name
		category = 'general', -- folder of where it's in
		date = 'Jun 08 2017 00:00', -- Just for printing, ordering is done by this table order
